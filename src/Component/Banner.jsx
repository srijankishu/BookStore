  ...
  return (
    <>
      <div className="w-full md:px-20 px-4 flex flex-col md:flex-row">
        <div className="order-2 md:order-1 md:w-1/2 mt-20 md:mt-20">
          <div className="mt-10 space-y-12">
            ...
            <p className="text-xl dark:text-white text-black">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime dignissimos natus mollitia quidem inventore commodi beatae quod quasi officia, dicta accusamus. Ipsam atque accusantium modi placeat quam alias! Numquam, maxime.
            </p>
        ...
        <div className="md:order-1 md:w-1/2 mt-20">
